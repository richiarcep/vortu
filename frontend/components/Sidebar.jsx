...
export default function Sidebar({ active }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Token malformado: limpiar y volver a login.
      ...
      <div style={{padding:'12px',borderTop:`1px solid ${T.hairline}`}}>
        {isAdmin && (
          <div className="sb-item"
            ...
            <span style={{width:18,height:18,display:'grid',placeItems:'center'}}>{I.shield}</span>
            <span>Backoffice</span>
            <span style={{marginLeft:'auto',fontSize:10,fontWeight:600,color:T.text4,letterSpacing:.5}}>ADMIN</span>
          </div>
        )}
      </div>
    </aside>
