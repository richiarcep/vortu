...
many places (nexum_engine, ai_service, admin, the llm_* clients). When a model is
...
while the Nexum super-admin engine used "claude-opus-4-7". Both are kept below as
...
OPUS_NEXUM = "claude-opus-4-7"      # used by the Nexum super-admin engine (see NOTE)
